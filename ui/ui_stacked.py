...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_date.setGeometry(QtCore.QRect(120, 160, 301, 51))
        font = QtGui.QFont()
        font.setPointSize(25)
        self.label_date.setFont(font)
        self.label_date.setObjectName("label_date")
        self.pushButton_mdcn_info = QtWidgets.QPushButton(self.page_0)
        self.pushButton_mdcn_info.setGeometry(QtCore.QRect(10, 210, 221, 111))
        font = QtGui.QFont()
        ...
        self.pushButton_record.setGeometry(QtCore.QRect(250, 210, 221, 111))
        font = QtGui.QFont()
        font.setPointSize(35)
        ...
        self.timeEdit_breakfast.setGeometry(QtCore.QRect(200, 120, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(30)
        ...
        self.timeEdit_lanch.setGeometry(QtCore.QRect(200, 190, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(30)
        ...
        self.timeEdit_dinner.setGeometry(QtCore.QRect(200, 260, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(30)
        ...
        self.label_9.setGeometry(QtCore.QRect(20, 110, 171, 61))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.label_9.setFont(font)
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(self.page_4)
        self.label_10.setGeometry(QtCore.QRect(30, 190, 161, 61))
        font = QtGui.QFont()
        font.setPointSize(18)
        ...
        self.label_11.setGeometry(QtCore.QRect(190, 160, 51, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_11.setFont(font)
        self.label_11.setObjectName("label_11")
        self.label_12 = QtWidgets.QLabel(self.page_4)
        self.label_12.setGeometry(QtCore.QRect(190, 240, 41, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.label_15.setGeometry(QtCore.QRect(10, 90, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_15.setFont(font)
        self.label_15.setObjectName("label_15")
        self.label_disp_mdcn_typenum = QtWidgets.QLabel(self.page_8)
        self.label_disp_mdcn_typenum.setGeometry(QtCore.QRect(10, 140, 81, 51))
        font = QtGui.QFont()
        font.setPointSize(23)
        ...
        self.label_disp_mdcn_img = QtWidgets.QLabel(self.page_8)
        self.label_disp_mdcn_img.setGeometry(QtCore.QRect(130, 90, 180, 130))
        self.label_disp_mdcn_img.setObjectName("label_disp_mdcn_img")
        self.label_page = QtWidgets.QLabel(self.page_8)
        self.label_page.setGeometry(QtCore.QRect(320, 90, 61, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_page.setFont(font)
        self.label_page.setFocusPolicy(QtCore.Qt.NoFocus)
        self.label_page.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_page.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.label_page.setFrameShadow(QtWidgets.QFrame.Plain)
        self.label_page.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByKeyboard)
        ...
        self.lcdNumber_clock_4 = QtWidgets.QLCDNumber(self.page_9)
        self.lcdNumber_clock_4.setGeometry(QtCore.QRect(50, 260, 311, 61))
        ...
        self.pushButton_disp_mdcn_back_2.setGeometry(QtCore.QRect(50, 240, 91, 51))
        font = QtGui.QFont()
        ...
        self.label_disp_mdcn_name_4 = QtWidgets.QLabel(self.page_10)
        self.label_disp_mdcn_name_4.setGeometry(QtCore.QRect(0, 30, 221, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_disp_mdcn_name_4.setFont(font)
        self.label_disp_mdcn_name_4.setObjectName("label_disp_mdcn_name_4")
        self.mdcn_yes = QtWidgets.QPushButton(self.page_10)
        self.mdcn_yes.setGeometry(QtCore.QRect(220, 20, 251, 61))
        self.mdcn_yes.setObjectName("mdcn_yes")
        self.mdcn_no_late = QtWidgets.QPushButton(self.page_10)
        self.mdcn_no_late.setGeometry(QtCore.QRect(220, 80, 251, 61))
        self.mdcn_no_late.setObjectName("mdcn_no_late")
        self.label_disp_mdcn_img_4 = QtWidgets.QLabel(self.page_10)
        self.label_disp_mdcn_img_4.setGeometry(QtCore.QRect(10, 80, 180, 130))
        self.label_disp_mdcn_img_4.setObjectName("label_disp_mdcn_img_4")
        self.mdcn_no_badcon = QtWidgets.QPushButton(self.page_10)
        self.mdcn_no_badcon.setGeometry(QtCore.QRect(220, 140, 251, 61))
        self.mdcn_no_badcon.setObjectName("mdcn_no_badcon")
        self.mdcn_no_other = QtWidgets.QPushButton(self.page_10)
        self.mdcn_no_other.setGeometry(QtCore.QRect(220, 260, 251, 61))
        self.mdcn_no_other.setObjectName("mdcn_no_other")
        self.mdcn_no_zero = QtWidgets.QPushButton(self.page_10)
        self.mdcn_no_zero.setGeometry(QtCore.QRect(220, 200, 251, 61))
        self.mdcn_no_zero.setObjectName("mdcn_no_zero")
        ...
        self.label_17.setGeometry(QtCore.QRect(90, 160, 341, 71))
        font = QtGui.QFont()
        font.setPointSize(25)
        ...
        self.label_18.setGeometry(QtCore.QRect(40, 40, 361, 71))
        font = QtGui.QFont()
        font.setPointSize(23)
        ...
        self.label_disp_mdcn_name_3 = QtWidgets.QLabel(self.page_15)
        self.label_disp_mdcn_name_3.setGeometry(QtCore.QRect(120, 70, 341, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_disp_mdcn_name_3.setFont(font)
        self.label_disp_mdcn_name_3.setObjectName("label_disp_mdcn_name_3")
        self.label_disp_mdcn_time_3 = QtWidgets.QLabel(self.page_15)
        self.label_disp_mdcn_time_3.setGeometry(QtCore.QRect(290, 120, 181, 101))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_disp_mdcn_time_3.setFont(font)
        self.label_disp_mdcn_time_3.setObjectName("label_disp_mdcn_time_3")
        self.label_disp_mdcn_num_3 = QtWidgets.QLabel(self.page_15)
        self.label_disp_mdcn_num_3.setGeometry(QtCore.QRect(340, 230, 71, 71))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.label_disp_mdcn_num_3.setFont(font)
        self.label_disp_mdcn_num_3.setObjectName("label_disp_mdcn_num_3")
        self.label_disp_mdcn_img_3 = QtWidgets.QLabel(self.page_15)
        self.label_disp_mdcn_img_3.setGeometry(QtCore.QRect(20, 110, 241, 151))
        self.label_disp_mdcn_img_3.setObjectName("label_disp_mdcn_img_3")
        self.label_page_3 = QtWidgets.QLabel(self.page_15)
        self.label_page_3.setGeometry(QtCore.QRect(130, 270, 61, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_page_3.setFont(font)
        self.label_page_3.setFocusPolicy(QtCore.Qt.NoFocus)
        self.label_page_3.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_page_3.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.label_page_3.setFrameShadow(QtWidgets.QFrame.Plain)
        self.label_page_3.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByKeyboard)
        ...
        self.pushButton_return_13 = QtWidgets.QPushButton(self.page)
        self.pushButton_return_13.setGeometry(QtCore.QRect(10, 20, 121, 71))
        self.pushButton_return_13.setText("")
        self.pushButton_return_13.setIcon(icon1)
        self.pushButton_return_13.setIconSize(QtCore.QSize(100, 100))
        self.pushButton_return_13.setFlat(True)
        self.pushButton_return_13.setObjectName("pushButton_return_13")
        self.label_39 = QtWidgets.QLabel(self.page)
        self.label_39.setGeometry(QtCore.QRect(170, 30, 261, 51))
        font = QtGui.QFont()
        font.setPointSize(25)
        self.label_39.setFont(font)
        self.label_39.setObjectName("label_39")
        self.label_40 = QtWidgets.QLabel(self.page)
        self.label_40.setGeometry(QtCore.QRect(80, 90, 61, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_40.setFont(font)
        self.label_40.setObjectName("label_40")
        self.label_41 = QtWidgets.QLabel(self.page)
        self.label_41.setGeometry(QtCore.QRect(80, 170, 61, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_41.setFont(font)
        self.label_41.setObjectName("label_41")
        self.label_42 = QtWidgets.QLabel(self.page)
        self.label_42.setGeometry(QtCore.QRect(80, 250, 61, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_42.setFont(font)
        self.label_42.setObjectName("label_42")
        self.timeEdit_breakfast_3 = QtWidgets.QTimeEdit(self.page)
        self.timeEdit_breakfast_3.setGeometry(QtCore.QRect(200, 90, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.timeEdit_breakfast_3.setFont(font)
        self.timeEdit_breakfast_3.setDateTime(QtCore.QDateTime(QtCore.QDate(2000, 1, 2), QtCore.QTime(5, 0, 0)))
        self.timeEdit_breakfast_3.setMaximumDateTime(QtCore.QDateTime(QtCore.QDate(2000, 1, 2), QtCore.QTime(23, 59, 59)))
        self.timeEdit_breakfast_3.setObjectName("timeEdit_breakfast_3")
        self.timeEdit_lunch_3 = QtWidgets.QTimeEdit(self.page)
        self.timeEdit_lunch_3.setGeometry(QtCore.QRect(200, 170, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.timeEdit_lunch_3.setFont(font)
        self.timeEdit_lunch_3.setDateTime(QtCore.QDateTime(QtCore.QDate(2000, 1, 1), QtCore.QTime(10, 0, 0)))
        self.timeEdit_lunch_3.setObjectName("timeEdit_lunch_3")
        self.timeEdit_dinner_3 = QtWidgets.QTimeEdit(self.page)
        self.timeEdit_dinner_3.setGeometry(QtCore.QRect(200, 250, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.timeEdit_dinner_3.setFont(font)
        self.timeEdit_dinner_3.setDateTime(QtCore.QDateTime(QtCore.QDate(2000, 1, 1), QtCore.QTime(17, 0, 0)))
        self.timeEdit_dinner_3.setObjectName("timeEdit_dinner_3")
        self.horizontalSlider_breakfast = QtWidgets.QSlider(self.page)
        self.horizontalSlider_breakfast.setGeometry(QtCore.QRect(200, 130, 160, 22))
        self.horizontalSlider_breakfast.setMaximum(20)
        self.horizontalSlider_breakfast.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_breakfast.setObjectName("horizontalSlider_breakfast")
        self.horizontalSlider_lunch = QtWidgets.QSlider(self.page)
        self.horizontalSlider_lunch.setGeometry(QtCore.QRect(200, 210, 160, 22))
        self.horizontalSlider_lunch.setMaximum(20)
        self.horizontalSlider_lunch.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_lunch.setObjectName("horizontalSlider_lunch")
        self.horizontalSlider_dinner = QtWidgets.QSlider(self.page)
        self.horizontalSlider_dinner.setGeometry(QtCore.QRect(200, 290, 160, 22))
        self.horizontalSlider_dinner.setMaximum(20)
        self.horizontalSlider_dinner.setSingleStep(1)
        self.horizontalSlider_dinner.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_dinner.setObjectName("horizontalSlider_dinner")
        self.stackedWidget.addWidget(self.page)
        MainWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(MainWindow)
        self.stackedWidget.setCurrentIndex(0)
        self.timeEdit_breakfast_3.timeChanged['QTime'].connect(MainWindow.set_mealtime_breakfast)
        self.timeEdit_lanch.timeChanged['QTime'].connect(MainWindow.set_mealtime_lunch)
        self.horizontalSlider_breakfast.sliderMoved['int'].connect(MainWindow.slider_breakfast)
        self.pushButton_return_13.pressed.connect(MainWindow.gopage_top)
        self.timeEdit_dinner.timeChanged['QTime'].connect(MainWindow.set_mealtime_dinner)
        self.pushButton_slct_yet.pressed.connect(MainWindow.slct_yet)
        ...
        self.horizontalSlider_lunch.sliderMoved['int'].connect(MainWindow.slider_lunch)
        self.pushButton_disp_mdcn_next_3.clicked['bool'].connect(MainWindow.disp_mdcn_next_3)
        ...
        self.timeEdit_breakfast.timeChanged['QTime'].connect(MainWindow.set_mealtime_breakfast)
        self.mdcn_no_zero.pressed.connect(MainWindow.mdcn_no_havezero)
        self.mdcn_no_other.pressed.connect(MainWindow.mdcn_no_other)
        self.timeEdit_dinner_3.timeChanged['QTime'].connect(MainWindow.set_mealtime_dinner)
        self.mdcn_no_late.pressed.connect(MainWindow.mdcn_no_late)
        self.mdcn_no_badcon.pressed.connect(MainWindow.mdcn_no_badcon)
        self.horizontalSlider_dinner.sliderMoved['int'].connect(MainWindow.slider_dinner)
        ...
        self.timeEdit_lunch_3.timeChanged['QTime'].connect(MainWindow.set_mealtime_lunch)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_slct_no.setText(_translate("MainWindow", "全て飲まない"))
        self.label_15.setText(_translate("MainWindow", "全部で"))
        self.label_disp_mdcn_typenum.setText(_translate("MainWindow", "n種類"))
        self.label_disp_mdcn_num.setText(_translate("MainWindow", "n錠"))
        self.label_disp_mdcn_img.setText(_translate("MainWindow", "TextLabel"))
        self.label_page.setText(_translate("MainWindow", "1/3"))
        ...
        self.pushButton_disp_mdcn_back_2.setText(_translate("MainWindow", "取消"))
        self.label_disp_mdcn_name_4.setText(_translate("MainWindow", "名前："))
        self.mdcn_yes.setText(_translate("MainWindow", "薬を飲んだ"))
        self.mdcn_no_late.setText(_translate("MainWindow", "薬を飲まない-起床遅い"))
        self.label_disp_mdcn_img_4.setText(_translate("MainWindow", "TextLabel"))
        self.mdcn_no_badcon.setText(_translate("MainWindow", "薬を飲まない-体調が悪い"))
        self.mdcn_no_other.setText(_translate("MainWindow", "薬を飲まない-その他"))
        self.mdcn_no_zero.setText(_translate("MainWindow", "薬を飲まない-薬がない,忘れた"))
        ...
        self.label_17.setText(_translate("MainWindow", "30分後に再アラーム"))
        ...
        self.label_disp_mdcn_name_3.setText(_translate("MainWindow", "名前："))
        self.label_disp_mdcn_time_3.setText(_translate("MainWindow", "朝・夕　お食事後"))
        self.label_disp_mdcn_num_3.setText(_translate("MainWindow", "n錠"))
        self.label_disp_mdcn_img_3.setText(_translate("MainWindow", "TextLabel"))
        self.label_page_3.setText(_translate("MainWindow", "1/3"))
        self.label_19.setText(_translate("MainWindow", "服薬記録送信履歴"))
        self.label_39.setText(_translate("MainWindow", "お食事時間設定"))
        self.label_40.setText(_translate("MainWindow", "朝食"))
        self.label_41.setText(_translate("MainWindow", "昼食"))
        self.label_42.setText(_translate("MainWindow", "夕食"))
